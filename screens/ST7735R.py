...
# This version requires numpy and adds robust resolution + rotation handling.
...
PHYSICAL_WIDTH = 128
PHYSICAL_HEIGHT = 160
ROTATION = get_config("screen", "rotation", fallback=270, type=int)  # must be (0,90,180,270)
...
# Create in-memory PIL image + draw handle
