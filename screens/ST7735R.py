...
PHYSICAL_HEIGHT = get_config("screen", "height", fallback=160, type=int)

ROTATION = get_config("screen", "rotation", fallback=90, type=int)  # must be (0,90,180,270)
...
DIAG_INCH = get_config("screen", "diag", fallback=1.77, type=float)
